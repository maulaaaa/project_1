...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 15 Jun 2026 pada 16.28
...
(id_pasien,nama_pasien,alamat_pasien,jenis_kelamin)
VALUES
(11,'Andi Pratama','Bandung','L');
SAVEPOINT point1;
INSERT INTO pasien
(id_pasien,nama_pasien,alamat_pasien,jenis_kelamin)
VALUES
(12,'Rina Maharani','Jakarta','P');
ROLLBACK TO SAVEPOINT point1;
INSERT INTO pasien
(id_pasien,nama_pasien,alamat_pasien,jenis_kelamin)
VALUES
(13,'Santi Nuraini','Bogor','P');
COMMIT;
SELECT * FROM pasien;
END$$
...
CREATE TABLE `administrator` (
  ...
  `waktu_jaga` varchar(20) DEFAULT NULL
...
CREATE TABLE `dokter` (
  ...
  `waktu_kerja` varchar(20) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
ALTER TABLE `daftar`
  ...
  ADD CONSTRAINT `daftar_ibfk_2` FOREIGN KEY (`id_admin`) REFERENCES `administrator` (`id_admin`);

--
-- Ketidakleluasaan untuk tabel `dokter_admin`
--
ALTER TABLE `dokter_admin`
  ADD CONSTRAINT `dokter_admin_ibfk_1` FOREIGN KEY (`id_dokter`) REFERENCES `dokter` (`id_dokter`),
  ADD CONSTRAINT `dokter_admin_ibfk_2` FOREIGN KEY (`id_admin`) REFERENCES `administrator` (`id_admin`);

--
-- Ketidakleluasaan untuk tabel `pasien_dokter`
--
ALTER TABLE `pasien_dokter`
  ADD CONSTRAINT `pasien_dokter_ibfk_1` FOREIGN KEY (`id_dokter`) REFERENCES `dokter` (`id_dokter`),
  ADD CONSTRAINT `pasien_dokter_ibfk_2` FOREIGN KEY (`id_pasien`) REFERENCES `pasien` (`id_pasien`);
COMMIT;
